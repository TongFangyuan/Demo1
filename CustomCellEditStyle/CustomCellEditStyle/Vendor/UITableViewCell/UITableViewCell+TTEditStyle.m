...
- (void)_configBtn:(UIButton *)btn style:(UITableViewCellEditButtonStyle *)style {
    ...
    style.image ? [btn setImage:style.image forState:UIControlStateNormal] : nil;
    style.backgroundImage ? [btn setBackgroundImage:style.backgroundImage forState:UIControlStateNormal] : nil;
    btn.imageEdgeInsets = style.imageEdgeInsets;
    btn.titleEdgeInsets = style.titleEdgeInsets;
